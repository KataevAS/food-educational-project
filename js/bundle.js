...
function calc() {
    ...
    function calcTotal() {
        ...
        if (sex === 'female') {
            ...
            result.textContent = Math.round(((13.4 * weight) + (4.8 * height) - (5.7 * age)) * ratio);
        }
    }
...
function slider({
    ...
    total.textContent = (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getZero)(slides.length);
    current.textContent = (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getZero)(slideIndex);
    ...
    function tranformSliderNav(totalSliders, currentSlide, offset) {
        ...
        total.textContent = (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getZero)(totalSliders);
        current.textContent = (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getZero)(currentSlide);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2020-11-11');
